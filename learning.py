...
from tensorflow.keras.layers import Dense, LSTM, TimeDistributed, Activation, Masking, Input, GlobalAveragePooling1D, Dropout, BatchNormalization
...
# Data preparation
data_folder = r'E:\138.뉴스 대본 및 앵커 음성 데이터\새 폴더'
